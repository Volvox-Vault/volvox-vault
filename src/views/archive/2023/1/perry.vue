...
<body>
    ...
    <div class="youtube">
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/yR84H48i1kU?si=Gn3hP_R3SrTeJgsY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
    ...
    <div class="ts-contain">
        ...
        <div class="ts-box">
            ...
            <p>
                ...
                <br><br>
                I recently moved to a new home in the last few months, and in my new living room I discovered that I am able to stand in a spot and see two cell towers simultaneously. After that, I began to imagine and research what happens materially when we send someone a text. Digital communication feels very personal and abstract, but there is an entire infrastructure that exists and is sometimes literally made invisible with things like "stealth towers" - perhaps some people have seen memes of fake palm trees with cell tower panels on them, for example.
               <br><br>
                <strong>What do you like most about your film?</strong>
                <br><br>
I've always enjoyed the way light and shadow work. In the first half I did some experimentation with cyan, magenta, and yellow lights rotating around the camera subject to see what might happen with the way the lights interact. Alternatives to linear perspective are also interesting to me, so using both orthographic and "regular" virtual cameras for this was very interesting.               
 <strong>What other mediums (apart from film) do you explore as an artist? How do they communicate with your film practice?</strong>
    ...
    <div class="chat" style="border: 1px dotted #212121; padding: 30px; height: 400px">
        ...
        <script type="application/javascript" id="cid0020000363489636523" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js" style="width: 100%; height: 100%">
{
    "handle": "tracingalan",
    "arch": "js",
    "styles": {
