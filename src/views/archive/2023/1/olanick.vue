...
<body>
    ...
    <div class="ts-contain">
        ...
        <div class="ts-box credits">
            ...
            <br />
            <p>
Director / Image / Sound: Lara Olanick
            </p>
        </div>
    ...
    <div class="chat" style="border: 1px dotted #212121; padding: 30px; height: 400px">
        ...
        <script type="application/javascript" id="cid0020000363491712107" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js" style="width: 100%; height: 100%">
{
    "handle": "megalara",
    "arch": "js",
    "styles": {
