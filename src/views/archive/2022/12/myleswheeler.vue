<template>
    ...
    <br><br>
    I just finished reading a book by a comedian called Katie Wicks, who's quite popular in the UK, and I hope around the world because she's really good. It's quite a life-changing book called Delicacy about her relationship with parents who aren't well, and with body image. There's so many bits where she weaves so many lovely poetic bits into it and it never really feels forced. It just feels so natural and it fits so well with the autobiographical factual stuff that she's listing about her life. It's so nicely tied together.
    <br><br>
    ...
    <br><br>
    Thanks for emailing and wanting to chat!
