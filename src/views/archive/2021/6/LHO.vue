  ...
  <div id="app">
    <body>
      <div
        ...
        "
      >
        <router-link to="/archive">back</router-link>
      </div>
      ...
      <div class="tours">
        ...
        <table>
          <tr>
            ...
            <td><a href="http://tianasroom.glitch.me/">you?</a></td>
          </tr>
          <tr>
            <td><a href="http://tianasroom.glitch.me/">friend</a></td>
            <td><a href="http://tianasroom.glitch.me/">friend</a></td>
            <td><a href="http://tianasroom.glitch.me/">friend</a></td>
          </tr>
        </table>
      ...
      <main>
        ...
        <p>
          ...
          <a href="https://youtu.be/w4m-RpaJuQI">here</a>.<br />
          Please submit the following to join...
        </p>
        ...
        <p>
          Email your submission to <b>hello@volvoxvault.com</b> by May 30th to
          invite us over. The gallery will be hosted at this URL in June.
        </p>
        ...
        <div style="border: 1px dashed midnightblue; padding: 15px">
          <p style="margin: 0px; padding: 0px">
            ...
            environments. With the pandemic, we've been stepping into each
            ...
            more about the nice people in our community, and have a chill time.
            [ A message sent from Tiana's room. ]
          </p>
        </div>
      </main>
    </body>
