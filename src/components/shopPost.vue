...
<div id="app">
        ...
        <div id="blocks-Shop">
            ...
            <div class="block-Shop">
                ...
                <p class="block-Shop-link shop-des"><a v-bind:href="item.website" target="_blank"><b>Shop</b></a> | {{item.des}}</p>
    ...
    data: function() {
        return {
            ...
            colony: [
            {
                ...
                des: '$40 CAD - 1 year subscription to a quarterly look inside of the global independent creative-scape.',
