<template>
  <div id="chat">
    <p v-if="!online">The pond is facing techinical difficulties. Please enjoy this temporary little pond. Follow our <a style="color: #f3f9e6; text-decoration: underline;" href="https://twitter.com/volvoxobserver">Twitter</a> for updates.<br>
